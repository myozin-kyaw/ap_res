...
Route::get('/searchingDish', [App\Http\Controllers\OrderController::class, 'dish_search'])->name('dish.search');
...
Route::get('/order', [App\Http\Controllers\DishesController::class, 'order_list'])->name('kitchen.orderList');
// function
